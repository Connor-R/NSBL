...
def name_parser(reverse_name):
    ...
    "Franklin (12/6/1997) Perez": ["Franklin", "Perez"],
    ...
    "Jose (4/5/1998) Garcia": ["Jose Israel", "Garcia"],
    "Jose Ozuna": ["Jose", "Osuna"],
    "Jose Hernandez-Urquidy": ["Jose", "Urquidy"],
    "Julio (1997) Rodriguez": ["Julio", "Rodriguez"],
    "Julio (2000) Rodriguez": ["Julio", "Rodgiguez"],
    ...
    "Luis (1/30/1987) Garcia": ["Luis", "Garcia"],
    "Luis (10/1/2000) Garcia": ["Luis", "Garcia"],
    "Luis (5/16/2000) Garcia": ["Luis", "Garcia"],
    ...
    "Tyler (1997) Watson": ["Tyler", "Watson"],
