...
CREATE TABLE `fg_grades_hitters` (
  ...
  `prospect_id` varchar(64) NOT NULL DEFAULT '',
...
CREATE TABLE `fg_prospects_draft` (
  ...
  `video` text,
  `blurb` text,
  PRIMARY KEY (`year`,`prospect_id`,`draft_age`,`lname`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `fg_prospects_international` (
  ...
  `video` text,
  `blurb` text,
  PRIMARY KEY (`year`,`prospect_id`,`full_name`,`j2_age`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `mlb_grades_hitters` (
  ...
  PRIMARY KEY (`year`,`prospect_id`,`prospect_type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
